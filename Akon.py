...
from primeMethods.primeMethods import disconnectAkon, getMemids, standby, checkAkonPresence, playLonely
...
def run_Akon():
    ...
    async def beautiful(ctx):
        ...
        if ctx.author.voice:
            ...
            voice.play(discord.FFmpegPCMAudio(executable="ffmpeg.exe", source="./mp3/Beautiful.mp3"))
